...
IF EXISTS(select * from sys.databases where name='Lab8')
	DROP DATABASE Lab8
...
insert into Berlok values 
	('1980305235445','Szilagyi Jeno','Kolozsvar','Scortarilor 79','1998-03-05','0732067895', 1),       --1
	('1580703343678','Andras Mihaly','Kolozsvar','Gr. Alexandrescu 5','1958-07-03', '0264435672', 4),  --2
	('2651220674387','Kiraly Aliz','Kolozsvar','Unirii 1','1965-12-20','0264789678', 6),			    --3
	('1710101102031','Csizmar Karoly','Nagyvarad','Closca 90','1971-01-01','0260361739', 4),		    --4
	('1860428679432','Balogh Imre','Kolozsvar','Paris 3','1986-04-28','0728345678', 1),				--5
	('2860709345213','Andras Hannah','Kolozsvar','Gr. Alexandrescu 5', '1986-07-09','0264435672', 1),	--6
	('1880123134389','Andor Zoltan','Szatmarnemeti','Karolyi ut 34','1988-01-23','0780345678', 3),		--7
	('1880919433235','Andras Ferenc','Kolozsvar','Gr. Alexandrescu 5','1988-09-19','0264435672', 3),	--8	
	('2491030269678','Nagy Ildiko','Kolozsvar','Motilor 2','1949-10-30','0751234786', 1),				--9
	('2900624986747','Kollo Ingrid','Csikszereda','Somesul 67','1990-06-24','0261868685', 4);			--10
