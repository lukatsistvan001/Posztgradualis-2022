USE master;
GO
IF EXISTS(SELECT * FROM sys.databases WHERE name='Konyvesuzlet_szem4')
	DROP DATABASE Konyvesuzlet_szem4

CREATE DATABASE Konyvesuzlet_szem4;
GO
USE Konyvesuzlet_szem4;
GO
...
CREATE TABLE Konyvek (
  ...
  Peldanyszam INT,
  EladasiAr FLOAT CHECK (EladasiAr>0)); 
...
INSERT INTO VasarlasTartalma(VasarlasID, KonyvKod, Mennyiseg) VALUES 
		(1,1, 5), (1,5, 6), (1,8, 1), (1,19, 1),
		(2,2, 2), 
        (3,14, 1), (3, 12, 5), (3,19,1),
		(4,16, 1), (4,17,1), (4,18,1),(4,1,2),
		(5,14, 1), (5,16,1), (5,18,1), (5,22,1),
		(6,2, 1), (6, 12, 4), (6,19,1);